			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				...
				<ul class="nav nav-pills" id="pills-tab" role="tablist">
					...
					<li class="nav-item"><a class="nav-link" id="pills-signup-tab"
						...
						aria-controls="pills-signup" aria-selected="false">Log out</a></li>
					...
					<form:form action="${pageContext.request.contextPath}/animalSave"
						...
						<div class="form-row">
							<div class="form-group col-md-3">
								...
								<form:input path="animalName" class="form-control" id="animalName" />
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-3">
						...
						<div class="form-row">
							...
							<label for="animalType">Select Your Companion</label> <select
								id="animalType" class="form-control">
